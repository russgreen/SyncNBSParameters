...
namespace SyncNBSParameters.Helpers;

internal static class ClientIdProvider
{
    private const string _defaultDirName = "SyncNBSParameters";
    private const string _defaultFileName = "client_id.txt";
    private const string _deterministicSalt = "syncnbsparams"; // product-specific salt
